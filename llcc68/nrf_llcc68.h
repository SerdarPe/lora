...
namespace LoRa
{
	...
	public:
		...
		NRF_LLCC68(const NRF_LLCC68 &) = delete;
		NRF_LLCC68 &operator=(const NRF_LLCC68 &) = delete;

		~NRF_LLCC68();

		void send_packet(const uint8_t *packet, uint8_t size);
		void reset();
	...
	private:
		...
		void set_standby(LLCC68_Constants::StandbyConfig s);
		/**
